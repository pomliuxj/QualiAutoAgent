import TestApi from "./views/project/api/updateApi/TestApi";
...
const TaskInfo = () => import('./views/project/task/TaskInfo.vue');
const GlobalParams = () => import('./views/project/global/GlobalParams.vue');
const GlobalDataBase = () => import('./views/project/global/GlobalDataBase.vue');
const TaskExecuteRecode = () => import('./views/project/task/TaskExecuteRecode.vue');
const TaskReport = () => import('./views/project/task/TaskReport.vue');
const AiTestCase = () => import('./views/project/automation/AiTestCase.vue');
...
let routes = [
...

    {
        ...
        children: [
            ...
            { path: '/about', component: About, iconCls:'fa fa-address-card', name: '使用文档'},
            ]
    },
    {
        path: '*',
        ...
        children: [
            ...
            {   path: '/automationTest/project=:project_id',
                    ...
                    children: [
                        ...
                        {   path: '/aiTestCase/project=:project_id', component: AiTestCase, name: 'AI生成用例'},
                    ]
            },
            {   path: '/TaskExecuteRecode/project=:project_id', component: TaskExecuteRecode, name: '定时任务记录',  projectHidden: true},
            ...
            {   path: '/TaskInfo/project=:project_id', component: TaskInfo, name: '定时任务', leaf: true},
            {   path: '/TaskReport/project=:project_id', component: TaskReport, name: '任务报告', leaf: true},
            {   path: '/GlobalDataBase/project=:project_id', component: GlobalDataBase, name: '数据源配置', leaf: true},
            {   path: '/GlobalParams/project=:project_id', component: GlobalParams, name: '全局变量', leaf: true},
        ]
    }
];
