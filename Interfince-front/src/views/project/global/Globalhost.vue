<template>
    <div style="margin:35px">
        ...
        <el-col :span="24" class="toolbar">
            ...
            <el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="20" :page-count="Math.ceil(total / 20)" style="float:right;">
            </el-pagination>
        </el-col>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" style="width: 60%; left: 20%">
            <el-form :model="editForm"  :rules="editFormRules" ref="editForm" label-width="80px">
                ...
                <el-form-item label="描述" prop='description'>
                    <el-input type="textarea" :rows="3" v-model.trim="editForm.description"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" style="width: 60%; left: 20%">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="描述" prop='description'>
                    <el-input type="textarea" :rows="3" v-model.trim="addForm.description"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
